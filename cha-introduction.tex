...
we empirically studied how the two aforementioned mechanisms%
---unsafe intrinsics and casting---are used by developers.
...
% DONE: third-party: what do you mean? Removed
...
Finally, in Chapter \ref{cha:casts} we present our \emph{casting} study.
The results of this chapter have been submitted for publication to OOPSLA'19.