...
For instance, it can assist an IDE to perform refactor analysis, such as renaming a method or field.
A static type system can be helpful to enforce disciplined programming.
When composing large-scale software, 
\emph{modular languages} are built-up of types, shown in the interfaces of modules.
Along these lines, type systems can be useful for \emph{documenting} purposes.
...
this information cannot be outdated, like comments in the source text.
...
Furthermore, in statically checked safe languages, \eg{}, \java{} or \rust{},
many checks are performed at compile-time, instead of being performed otherwise at run-time.
Compare this to dinamically checked safe languages,
where all checks need to be performed at runtime,
degrading performance.

\input{chapters/casts/table-casts-langs}
...
is unsupported\urlnote{http://www.oracle.com/technetwork/java/faq-sun-packages-142232.html}
and undocumented.
