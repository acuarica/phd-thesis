...
\footnote{Please notice that the snippets presented here were slightly modified for formatting purposes.}
...
\input{chapters/casts/PatternMatching.tex}
\input{chapters/casts/Literal}
\input{chapters/casts/Prim.tex}
\input{chapters/casts/RawTypes.tex}
\input{chapters/casts/Family.tex}
\input{chapters/casts/LookupById.tex}
\input{chapters/casts/Factory.tex}
\input{chapters/casts/TypeTag.tex}
\input{chapters/casts/Equals.tex}
\input{chapters/casts/SelectOverload.tex}
\input{chapters/casts/Redundant.tex}
\input{chapters/casts/KnownLibraryMethod.tex}
\input{chapters/casts/NewDynamicInstance.tex}
\input{chapters/casts/Clone.tex}
\input{chapters/casts/ImplicitIntersectionType.tex}
\input{chapters/casts/Deserialization.tex}
\input{chapters/casts/StaticResource.tex}
\input{chapters/casts/ObjectAsArray.tex}
\input{chapters/casts/ReflectiveAccessibility.tex}
\input{chapters/casts/ExceptionSoftening.tex}
