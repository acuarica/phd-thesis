...
\begin{figure}[ht!]
\centering
\includegraphics[width=\columnwidth]{java-cast-queries/analysis/table-patterns.pdf}
...
\input{java-cast-queries/ql/PatternMatching}
\input{java-cast-queries/ql/TypeTag}
\input{java-cast-queries/ql/ObjectAsArray}
\input{java-cast-queries/ql/Deserialization}
\input{java-cast-queries/ql/Equals}
\input{java-cast-queries/ql/Factory}
\input{java-cast-queries/ql/LookupById}
\input{java-cast-queries/ql/NewDynamicInstance}
\input{java-cast-queries/ql/ReflectiveAccessibility}
\input{java-cast-queries/ql/SelectOverload}
\input{java-cast-queries/ql/StaticResource}
\input{java-cast-queries/ql/NotDeclaredInterface}
\input{java-cast-queries/ql/Literal}
\input{java-cast-queries/ql/RawType}
\input{java-cast-queries/ql/ExceptionSoftening}
\input{java-cast-queries/ql/Family}
