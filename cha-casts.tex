...
As defined by the~\java{} Language Specification\footnote{\url{https://docs.oracle.com/javase/specs/jls/se8/html/jls-5.html}},
...
Thus, in addition to the cast operator, the \code{instanceof}\footnote{\url{https://docs.oracle.com/javase/specs/jls/se8/html/jls-15.html\#jls-15.20.2}} operator tests whether an expression can be casted without throwing a \code{ClassCastException}.
