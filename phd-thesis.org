...
:END:
*** Page 44: The programmer is neither required to handle not to specify it
*** Page 45: Downcast/unboxing sentence, be correct and more descriptive
*** Page 68: Remove word API
*** Page 69: Typo->pick wrong class name
*** Page 70: Listing 4.8 small long to capital Long, uses the boxed version
*** 4.3 glue sentence
*** 4.3 Manual detection of Cast pattern belong ~s~
*** 4.3 other ~s~ cast expression
*** 4.3 database not use, impossible->impractical
*** Remove best-effort sentence.
*** the the typo
...
*** The authors: I discussed with my advisors
