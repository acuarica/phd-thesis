...
Finally~\ref{sec:literature-review:conclusions} concludes this chapter.
...
\cite{tanSafeJavaNative2006} propose a safe variant of the \java{} Native Interface (\jni{}).
...
Chapters~\ref{cha:unsafe} and \ref{cha:casts} provide the first empirical studies on the \unsafe{} \api{} and cast operator in \java{}. 
