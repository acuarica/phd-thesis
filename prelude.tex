...
\newcommand{\crqAdesc}{We want to understand to what extent application code actually uses casting operations.}
\newcommand{\crqBdesc}{If casts are actually used in application code, we want to know how and when developers need to escape the type system.}
