...
It is used in the Java Fork/Join framework to save the generic exception of a thread to be rethrown later.}
...
the Maven dependency graph described in Section~\ref{sec:maven}.

\input{chapters/unsafe/table-pats}
