...
To answer \ref{casts:rq1} (\emph{\crqA}), several elements are needed.
...
\textbf{Projects.} 
As a code base representative of the ``real world'', we have chosen open-source projects hosted in \github{}, the world-most popular source code management repository.
...
The \emph{Number of Expressions} value show how many expressions there are in the ASTs of all source code analyzed.
