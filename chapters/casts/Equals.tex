...
A cast expression is guarded by either an \code{instanceof} test or a \code{getClass} comparison (to the same target type as the cast);
in an \code{equals}\footnote{\url{https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html\#equals-java.lang.Object-}} method implementation.
...
\related{}
Related to \pname{PatternMatching}.
\end{pattern}