...
\hdr \# & \textbf{Cast Pattern} & \textbf{Cast Pattern Description} & \textbf{Group} \\ \hline
 ...
 5 & \nameref{pat:Family}                     & A cast applied in a family of classes.                                                                                & \multirow{7}{*}{Creational}   \\
 6 & \nameref{pat:Factory}                    & A cast used to convert a newly created objects.                                                                       &                               \\
 7 & \nameref{pat:KnownLibraryMethod}         & When the client of an API knows the exact return type of a method invocation.                                         &                               \\
