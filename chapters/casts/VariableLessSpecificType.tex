...
The \code{samlTokenRenewer} variable is being casted to the \code{SAMLTokenRenewer} class.
...
the parameter \code{k1} is casted to the \code{Comparable} class (line 7).
