...
%
\todo{Matthias: And again, in-line an enumeration of those elements into this sentence.}
%
...
\todo{Matthias: What is the point of this sentence?}
...
\todo{Matthias: Insert paragraph break here, and improve the clarity of the subsequent text.}
...
\todo{Matthias: Who has two distinct features? The distribution? The subjects?}
...
\todo[inline]{Put your raw results (the file with the 5000 cast instances and your tags) into some repo and say here that it's available there.}
