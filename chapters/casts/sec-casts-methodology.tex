...
%
\done{Matthias: And again, in-line an enumeration of those elements into this sentence. [DISCUSS] Luis: I would prefer to have them as an enumeration.}
%
...
\done{Matthias: What is the point of this sentence? {\scriptsize "We assume that all cast instances can be categorized in several patterns."}}
%
...
\done{Matthias: Insert paragraph break here, and improve the clarity of the subsequent text.}
%
...
%
\done{Matthias: Who has two distinct features? The distribution? The subjects?}
%
...
\done{Matthias: Put your raw results {\scriptsize (the file with the 5000 cast instances and your tags)} into some repository and say here that it's available there.}
%
