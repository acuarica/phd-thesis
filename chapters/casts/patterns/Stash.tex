...
\plot{patterns/table-pattern-Stash-features}{fig:casts:stash}{\thisp{} Variants Occurrences}
...
The \variant{StaticResource} variant of this pattern is to retrieve a value instantiated from
