...
\detection{}
The implementation of the two variants---\variant{StaticResource} and \variant{Tag}---is application-specific.
...
\begin{listing}
\begin{minted}{java}
final class LookupByIdCast extends #\qlref{Cast}# { #\qlbox#
	private MethodAccess methodAccess;
	private Method getterMethod;
	private FieldAccess constantField;
	LookupByIdCast() {
		methodAccess = getOperand() and
