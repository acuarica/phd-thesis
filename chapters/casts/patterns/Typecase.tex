...
The \variant{GuardByClassLiteral} variant may be used instead of the \code{instanceof} operator when the developer wants to match exactly the runtime class.
