...
Since the arguments are known at compile-time,
cast to the specific type.
\done{Nate: Create with type descriptor "Tag"}
In this pattern, the arguments resembles a type ``tag'' descriptor.
...
\related{}
\done{Nate: Move to "Related Patterns"}
The \thisp{} pattern cast a method call result to a subtype of the declared return type.
This can be seen as a special case of \nameref{pat:Family} polymorphism pattern,
where several subclasses are meant to work together.
