...
class NewDynamicInstanceCastPattern extends CastPattern {
	NewDynamicInstanceCastPattern() {
		getExpr() instanceof NewDynamicInstanceAccess
	}
	override string getPattern() { result = "NewDynamicInstance" }
}
\end{minted}
\end{listing}
...
\begin{listing}
\begin{minted}[linenos=false,escapeinside=||]{gas}
|\bcbox|
