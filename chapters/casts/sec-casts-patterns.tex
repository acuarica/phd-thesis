...
\todo{Matthias: Start a new subsection here.}
\todo{Matthias: When describing each pattern, you may want to repear the number of occurrences within the description (maybe as part of the section title, or just below)}
...
comment \code{// [...]}.
%
\todo{Nate: What's the orange (hightlight color) mean? The line with the cast being inspected. Explain here}
%
...
%
\todo{Nate: List project name too.}
\todo{Luis: Mention that the back links were customized to include the project names.}
%
...
\todo[inline]{Matthias: Say what it means to be guarded.}
